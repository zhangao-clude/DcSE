...
def evaluate_ensemble(y_true, y_probs, threshold=0.5, save_dir="./results", split_id=None):
    ...
    filename = f"{save_dir}/human_metrics.txt"
    if split_id is not None:
        filename = f"{save_dir}/human_metrics_split_{split_id}.txt"
...
if __name__ == "__main__":
    ...
    for i in range(num_splits):
        ...
        model_configs = [
            {
                "path": f"./DcSEResult/True_model_split_{i}/{species}_model/fold_1/final.pth",
                "model_class": Mymodel,
                "weight": 1.0,
            },
            {
                "path": f"./DcSEResult/True_model_split_{i}/{species}_model/fold_2/final.pth",
                "model_class": Mymodel,
                "weight": 1.0,
            },
            {
                "path": f"./DcSEResult/True_model_split_{i}/{species}_model/fold_3/final.pth",
                "model_class": Mymodel,
                "weight": 1.0,
            },
            {
                "path": f"./DcSEResult/True_model_split_{i}/{species}_model/fold_4/final.pth",
                "model_class": Mymodel,
                "weight": 1.0,
            },
            {
                "path": f"./DcSEResult/True_model_split_{i}/{species}_model/fold_5/final.pth",
                "model_class": Mymodel,
                "weight": 1.0,
            }
        ]
